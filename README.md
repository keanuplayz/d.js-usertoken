...
```js
"dependencies": {
    "discord.js": "github:keanuplayz/discord.js"
  }
```

after that if you set your client.options.user = true, you can use your user token in your to log in.
example:
...
# I don't take any responsibility for banned Discord accounts that used this module.

# Using this on a user account is prohibited by the Discord TOS and can lead to account termination.
